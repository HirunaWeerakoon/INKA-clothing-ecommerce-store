...
-- Categories
MERGE INTO category (id, name, image_url) KEY(id) VALUES
...
MERGE INTO products (product_id, category_id, name, description, price, stock, is_available, best_seller, image_url, image1, image2, image3, image4, image5) KEY(product_id) VALUES
...
MERGE INTO sub_category (id, name, image_url, category_id) KEY(id) VALUES (1, 'Crew Neck', null, 1);
MERGE INTO sub_category (id, name, image_url, category_id) KEY(id) VALUES (2, 'V-Neck', null, 1);
MERGE INTO sub_category (id, name, image_url, category_id) KEY(id) VALUES (3, 'Polo', null, 1);

-- Sub Categories for Denims (category_id = 2)
MERGE INTO sub_category (id, name, image_url, category_id) KEY(id) VALUES (4, 'Slim Fit', null, 2);
MERGE INTO sub_category (id, name, image_url, category_id) KEY(id) VALUES (5, 'Regular', null, 2);
MERGE INTO sub_category (id, name, image_url, category_id) KEY(id) VALUES (6, 'Wide Leg', null, 2);

-- Sub Categories for Tote Bags (category_id = 3)
MERGE INTO sub_category (id, name, image_url, category_id) KEY(id) VALUES (7, 'Small', null, 3);
MERGE INTO sub_category (id, name, image_url, category_id) KEY(id) VALUES (8, 'Medium', null, 3);
MERGE INTO sub_category (id, name, image_url, category_id) KEY(id) VALUES (9, 'Large', null, 3);
